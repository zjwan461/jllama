<template>
  <div>
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>结算历史查询</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      <el-form inline>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    getSettleList() {
      ...
      this.$http.get('/admin/api/settle/list?page=' + this.page + '&limit=' + this.limit + '&dateScope=' + dateScope)
        .then(res => {
          if (res.data.code !== 0) {
